...
from Graph.PeopleConnectionGraph import Graph, PeopleConnectionGraph
...
if __name__ == '__main__':
    # Create an instance of CheckConnection
    check = CheckConnection(
        8,
        sentence_input_path="text_analyzer/2_examples/Q8_examples/exmaple_3/sentences_small_3.csv",
        people_input_path="text_analyzer/2_examples/Q8_examples/exmaple_3/people_small_3.csv",
        remove_input_path="text_analyzer/1_data/Data/REMOVEWORDS.csv",
        Threshold=2,
        WindowSize=5,
        k=5,
        People_connections_to_check="text_analyzer/2_examples/Q8_examples/exmaple_3/people_connections_3.json",
        fixed_length=True
    )
    check1 = CheckConnection(
            8,
            sentence_input_path="text_analyzer/2_examples/Q8_examples/example_1/sentences_small_1.csv",
            people_input_path="text_analyzer/2_examples/Q8_examples/example_1/people_small_1.csv",
            remove_input_path="text_analyzer/1_data/Data/REMOVEWORDS.csv",
            Threshold=2,
            WindowSize=3,
            k=8,
            People_connections_to_check="text_analyzer/2_examples/Q8_examples/example_1/people_connections_1.json",
            fixed_length=True
        )
    print(check1.return_results())
    ...
    #     return format(execution_time, ".30f"), output
    #
    #
    # # Pass the function reference (without parentheses) to measure_execution_time.
    # execution_time, result = measure_execution_time(check.return_results)
    #
