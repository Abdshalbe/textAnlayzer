...
from textAnlayzer.SequinceCounter import load_Sentences_names
...
class SentenceGraph:
    ...
    def __dfs(self, node, visited, component):
        """
        find all the connected nodes in the graph that connected to node
        :param node: node representing the current node
